...
var TEXTE = {
  de: {
    ...
    text: 'Wir messen die Nutzung dieser Website mit Google Analytics 4 und den Erfolg unserer Werbung mit dem Meta-Pixel und Google Ads. Den Meta-Pixel und die Werbe-Cookies von Google Ads laden wir erst nach Ihrer Zustimmung. Ihre Wahl gilt f&uuml;r diesen Browser und l&auml;sst sich jederzeit &auml;ndern.',
    accept: 'Akzeptieren',
    deny: 'Ablehnen',
    link: 'Datenschutz',
  ...
  en: {
    ...
    text: 'We measure how this website is used with Google Analytics 4, and how our advertising performs with the Meta pixel and Google Ads. The Meta pixel and Google Ads advertising cookies are only used once you agree. Your choice applies to this browser and can be changed at any time.',
    accept: 'Accept',
    deny: 'Decline',
    link: 'Privacy policy',
    href: '/privacy.html'
